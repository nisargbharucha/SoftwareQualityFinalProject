...
public class Utilities {
    ...
    public list<Flight> getReturnFlights(String departure, String destination, DateTimeFormatter day) {
        // will return all flights that coming from the destination and go back to
        // departure, on a
    ...
    public list<Flight> getMultistopFlights(String old_destination, String new_destination,
        ...
        // used to find flights that have a stop in them. a flight that is going from A
        // -> B will need another flight that is
        // going from B -> C. This will find a flight that goes from the old destination
        // (B) to a new destination (C)
