...
public class UtilitiesTest {
    ...
    public void testDirectFlights() {
        ...
        when(utilitiesMock.getAllFlights()).thenReturn(flights); // when this method is run, then return this list of
        // flights
        // List<Flight> result = utilities.getDirectFlights("Toronto",
        // "California").size();
